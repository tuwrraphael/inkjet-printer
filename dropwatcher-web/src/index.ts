...
let hmrComponentCounter = 0;
let appComponent: AppComponent = document.querySelector(AppComponentTagName);

if (module.hot) {
    module.hot.accept("./components/AppComponent/AppComponent", async () => {
        document.body.removeChild(appComponent);
        let newTagName = AppComponentTagName + hmrComponentCounter++;
        customElements.define(newTagName, AppComponent);
        appComponent = <AppComponent>document.createElement(newTagName);
