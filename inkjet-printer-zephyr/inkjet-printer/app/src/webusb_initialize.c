...
LOG_MODULE_REGISTER(webusb_init, CONFIG_APP_LOG_LEVEL);
...
static struct msosv2_descriptor_t
{
     ...
     * Subset Header.
     */
    .subset_header = {.wLength = sizeof(struct msosv2_function_subset_header), .wDescriptorType = MS_OS_20_SUBSET_HEADER_FUNCTION,
...
USB_DEVICE_BOS_DESC_DEFINE_CAP struct usb_bos_webusb_desc
{
     ...
     */
    .platform = {
        .bLength = sizeof(struct usb_bos_platform_descriptor) + sizeof(struct usb_bos_capability_webusb),
    ...
    .cap = {.bcdVersion = sys_cpu_to_le16(0x0100), .bVendorCode = 0x01, .iLandingPage = 0x01}};
...
USB_DEVICE_BOS_DESC_DEFINE_CAP struct usb_bos_msosv2_desc
{
     ...
     */
    .platform = {
        .bLength = sizeof(struct usb_bos_platform_descriptor) + sizeof(struct usb_bos_capability_msos),
        .bDescriptorType = USB_DESC_DEVICE_CAPABILITY,
        .bDevCapabilityType = USB_BOS_CAPABILITY_PLATFORM,
        .bReserved = 0,
        .PlatformCapabilityUUID = {
    ...
    .cap = {/* Windows version (8.1) (0x06030000) */
            .dwWindowsVersion = sys_cpu_to_le32(0x06030000),
            .wMSOSDescriptorSetTotalLength = sys_cpu_to_le16(sizeof(msosv2_descriptor)),
...
SYS_INIT(webusb_init, APPLICATION, CONFIG_APPLICATION_INIT_PRIORITY);